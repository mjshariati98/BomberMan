...
public class BomberMan extends Character {
    ...
    public int getScore() {
        if (getGameFrame().getGameType() == GameFrame.Type.SINGLE && score < 0) {
            GameOverFrame gameOver = new GameOverFrame(getGameFrame());
        }
        return score;
    }
    ...
    public void setScore(int score) {
        this.score = score;
        if (getGameFrame() != null && getMap().getScoreBoard() != null)
            getMap().getScoreBoard().updateScore(getScore());
    }
    ...
    public void respawn() {
        if (!respawning) {
            ...
            setScore(getScore() - gameFrame.getLevelManager().getLevelNumber() * 100);
        }
    }
    ...
    public void move(Direction direction) {
        ...
        if (getGameFrame() != null && getGameFrame().getGameType() == GameFrame.Type.SINGLE)
            findItem();
    }
